...
INSERT INTO tb_atividade(id,categoria_id,nome, descricao, preco) VALUES(1, 1, 'Curso de HTML', 'Aprenda HTML de forma prática', 80.00);
INSERT INTO tb_atividade(id,categoria_id,nome, descricao, preco) VALUES(2, 2, 'Oficina de GitHub', 'Controle versões de seus projetos', 50.00);
